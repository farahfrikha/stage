...
<body>
    ...
    <h1>Étape 3 sur 9</h1>
    <form>
    <label for="additionalInfo">quelle est la surface des travaux en metre carré</label>
...
<div class="step" id="step4" style="display: none;">
    <h1>Étape 4 sur 9</h1>
    <h2>etes-vous propriéraire du bien ?</h2>
    <form>
        <div class="options">
            <input type="radio" id="e1" name="entretient" value="e1">
            <label for="e1">en cours de signature</label>
